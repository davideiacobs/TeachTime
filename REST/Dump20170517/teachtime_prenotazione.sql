...
CREATE TABLE `prenotazione` (
  ...
  PRIMARY KEY (`ripetizione_ID`,`utente_ID`,`materia_ID`,`materia_categoria_ID`),
  ...
  CONSTRAINT `fk_prenotazione_utente1` FOREIGN KEY (`utente_ID`) REFERENCES `utente` (`ID`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
-- Dump completed on 2017-05-17 15:23:28
